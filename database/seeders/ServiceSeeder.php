        ...
        $services = [
                ...
                [
                    ...
                    'content' => [
                        [
                            ...
                            'content' => '<p>تُعد <strong>تسربات المياه من أخطر المشاكل</strong> التي تواجه المنازل والفلل والعمائر في مدينة الرياض، حيث تؤدي إلى أضرار جسيمة في البنية التحتية للمبنى، وارتفاع غير مبرر في فاتورة المياه، وظهور الرطوبة والعفن على الجدران والأسقف.</p>
            <p>بسبب طبيعة المناخ في السعودية، وتهالك بعض شبكات السباكة، تصبح التسربات مشكلة صامتة لا يلاحظها العميل إلا بعد حدوث تلف كبير، وهنا تظهر أهمية <strong>الكشف المبكر عن تسربات المياه بدون تكسير</strong>.</p>'
                        ],
                        [
                            'title' => 'ما المقصود بكشف تسربات المياه بدون تكسير؟',
                            'content' => '<p>كشف تسربات المياه بدون تكسير هو استخدام <strong>تقنيات وأجهزة إلكترونية حديثة</strong> تستطيع تحديد مكان التسرب بدقة عالية داخل الجدران أو الأرضيات دون الحاجة إلى تكسير البلاط أو الحوائط.</p>
            ...
            <ul>
                ...
                <li>حل نهائي للتسرب.</li>
                        ...
                        [
                            ...
                            'content' => '<p>من خلال خبرتنا الطويلة في كشف تسربات المياه بالرياض، وجدنا أن أكثر الأسباب شيوعًا تشمل:</p>
            <ul>
                ...
                <li>عدم وجود عزل مائي جيد للأسطح والحمامات.</li>
                        ...
                        [
                            ...
                            'content' => '<p>تعتمد مؤسسة رؤية الخليج على أحدث الأجهزة المعتمدة عالميًا في كشف تسربات المياه بدون تكسير، ومنها:</p>
            <ul>
            ...
            <p>جميع الأجهزة يتم معايرتها بدقة لضمان نتائج صحيحة 100%.</p>'
                        ...
                        [
                            ...
                            'content' => '<p>نلتزم في رؤية الخليج بخطوات مدروسة تضمن أفضل نتيجة:</p>
            <ol>
                ...
                <li>تنفيذ الإصلاح في حال طلب العميل.</li>
                        ...
                        [
                            ...
                            'content' => '<p>إذا كنت تعاني من <strong>ارتفاع فاتورة المياه في الرياض</strong> بدون سبب واضح، فغالبًا يوجد تسرب مخفي داخل الجدران أو الأرضيات.</p>
