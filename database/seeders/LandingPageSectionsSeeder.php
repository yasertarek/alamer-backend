        ...
        $sections = [
          ...
          خدمات عزل مبتكرة تحت رعايتكم',
            ...
            [
                ...
                'order' => 5,
                'data' => [
                    'title' => 'كشف تسربات المياه بالرياض | عزل أسطح معتمد وضمان – رؤية الخليج',
                    'description' =>
                    "شركة رؤية الخليج تقدم كشف تسربات المياه بالرياض بدون تكسير بأحدث الأجهزة، مع عزل اسطح احترافي وضمان معتمد. اتصل الآن لخدمة سريعة وأسعار منافسة.",
